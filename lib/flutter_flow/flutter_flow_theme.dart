...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF4C00);
  late Color secondary = const Color(0xFFF3F3F3);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF4C00);
  late Color secondary = const Color(0xFF121212);
  late Color tertiary = const Color(0xFF1E1E1E);
  late Color alternate = const Color(0xFF2F2F2F);
  late Color primaryText = const Color(0xFFECECEC);
