...
class EONDigitalSupabaseUser extends BaseAuthUser {
  EONDigitalSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> eONDigitalSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = EONDigitalSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
